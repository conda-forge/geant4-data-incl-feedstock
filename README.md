...
Once the `conda-forge` channel has been enabled, `geant4-data-incl` can be installed with:

```
conda install geant4-data-incl
```

It is possible to list all of the versions of `geant4-data-incl` available on your platform with:
